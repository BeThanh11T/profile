...
# Updating the script.js code to support a 12x12 grid layout with 144 cells

updated_script_content_12x12 = """
...
# Writing the updated script.js content for 12x12 back to the file

with open(new_script_path, 'w') as file:

    file.write(updated_script_content_12x12)



updated_script_content_12x12[:1000]  # Displaying the first 1000 characters of the updated script for verification
